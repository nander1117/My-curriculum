        ...
        aside { class: "drawer ",
            ...
            div { class: "drawer-side",
                ...
                ul { class: "menu bg-base-200 text-base-content min-h-full w-80 p-4",
                    aside { class: "flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700 animation-sidebar",
