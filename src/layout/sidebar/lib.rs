...
pub fn Sidebar() -> Element {
    rsx! (
        ...
        aside { class: "peer lg:flex flex-col w-64 h-screen  overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700 animation-sidebar hidden",
                ...
                div { class: "flex flex-col justify-between flex-1 mt-6",
                    nav {
                        ...
                        a {
                            ...
                            span { class: "mx-4 font-medium", "Accounts" }
                        }
                        a {
                            class: "flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700",
                            href: "#",
                            ...
                            span { class: "mx-4 font-medium", "Tickets" }
                        }
                        a {
                            class: "flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700",
                            href: "#",
...
#[component]
pub fn OCSidebar() -> Element {
    rsx!(input {
        aria_label: "close sidebar",
        r#type: "checkbox",
        id: "close-sidebar-desktop",
        class: "hidden ",
    })
}
